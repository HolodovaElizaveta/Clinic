"""
Django settings for medbooking project.
...
SECRET_KEY = 'django-insecure-kh=s4*^f)mf5j0pf+4v0)q3_@-gf$hp=e9nye&@d*s&ws*&gt$'
...
WSGI_APPLICATION = 'medbooking.wsgi.application'
...
# Загружаемые файлы (PDF, фото и т.д.)
import os
...
# После входа перенаправлять на главную
LOGIN_REDIRECT_URL = '/'
